...
// 모델명 목록 (우선순위 순) — https://ai.google.dev/gemini-api/docs/models 기준 안정/현행 ID
...
app.post('/api/story', async (req, res) => {
    try {
        ...
        if (!story) {
            ...
            console.error('[Gemini] 환경 변수 GEMINI_MODEL_PRIORITY로 모델 우선순위를 지정할 수 있습니다. 예) gemini-2.5-flash,gemini-2.5-pro');
...
// 정적 프론트엔드 (로컬·단일 서버 실행 시 GET / 에서 UI 제공)
app.get('/', (req, res) => {
